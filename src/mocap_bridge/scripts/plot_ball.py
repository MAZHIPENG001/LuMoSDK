...
# ================= 1. 加载和预处理数据 =================
data_dir = '/home/ma/GithubDoc/LuMoSDK/src/mocap_bridge/scripts/data/20260701_102659'
...
# 提取动捕中的 足球数据(marker 1) 和 相机位姿数据(rigid 4)
...
# 线性插值动捕足球真值
aligned_df['gt_x'] = np.interp(aligned_df.index, ball_gt.index, ball_gt['x'])
aligned_df['gt_y'] = np.interp(aligned_df.index, ball_gt.index, ball_gt['y'])
aligned_df['gt_z'] = np.interp(aligned_df.index, ball_gt.index, ball_gt['z'])
